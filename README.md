...
- `VERSION_TAG`: "latest" or a specific version tag. Tonic's tag convention is just the release number, e.g. "123". Release notes are available at [docs.tonic.ai](https://www.tonic.ai/product-release-notes/structural).
